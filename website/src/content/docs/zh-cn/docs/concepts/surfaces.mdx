...
- **`TurnState`** — 来自 [`bub.turn`](https://github.com/bubbuild/bub/blob/main/src/bub/turn.py) 的 per-turn dict，由各 hook 通过 [`load_state`](/zh-cn/docs/concepts/turn-pipeline/) 贡献，并存活到 [`save_state`](/zh-cn/docs/concepts/turn-pipeline/) 完成为止。
...
- [核心契约参考](/zh-cn/docs/reference/types/) — 各子系统拥有的类型与访问 helper。
