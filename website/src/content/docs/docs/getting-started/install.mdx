...
The `recommended` preset includes both [`bub-mcp`](/docs/tutorials/mcp/) and
[`bub-agent-plugins`](/docs/tutorials/agent-plugins/). Together they support your existing MCP servers and
portable Agent Plugins that bundle skills and MCP servers. The installer adds the Python integrations;
place portable plugin directories in `.agents/plugins/` to load them.
...
- [Load Agent Plugins](/docs/tutorials/agent-plugins/) — add portable skills and MCP servers alongside existing plugins.
