---
title: Skills
description: Skills as SKILL.md documents — minimal contract, frontmatter fields, discovery and override, runtime access, authoring guidance, and script convention.
---
