---
title: Channels
description: Channel adapters (CLI, Telegram), run modes, session semantics, outbound delivery surfaces, and debounce behavior.
---
...
- `cli`: local interactive terminal — see [CLI](cli)
- `telegram`: Telegram bot — see [Telegram](telegram)
