...
- Streaming presentation is **not** enabled; the framework still consumes the model through the sole `HookRuntime.run_model_stream` path and buffers its text for final output.
